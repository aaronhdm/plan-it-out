// Time functions.
var today = moment();
$("#1a").text(today.format("MMMM Do, YYYY HH:mm"));
var format = 'HH:mm'
var time = moment();

// Timeblock 1
// Function to color code timeblock.
function one () {
beforeTime = moment('09:00', format),
afterTime = moment('10:00', format);
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("one").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("one").style.backgroundColor = "#F08080"
} else {
  document.getElementById("one").style.backgroundColor = "#20B2AA"
}
};
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("two").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("two").style.backgroundColor = "#F08080"
} else {
document.getElementById("two").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
two();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("three").style.backgroundColor = "	#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("three").style.backgroundColor = "#F08080"
} else {
document.getElementById("three").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
three();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("four").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("four").style.backgroundColor = "#F08080"
} else {
document.getElementById("four").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
four();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("five").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("five").style.backgroundColor = "#F08080"
} else {
document.getElementById("five").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
five();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("six").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("six").style.backgroundColor = "#F08080"
} else {
document.getElementById("six").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
six();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("seven").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("seven").style.backgroundColor = "#F08080"
} else {
document.getElementById("seven").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
seven();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("eight").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("eight").style.backgroundColor = "#F08080"
} else {
document.getElementById("eight").style.backgroundColor = "#20B2AA"
}
};
// Activating color-coding time function on page load.
eight();
...
if (time.isBetween(beforeTime, afterTime)) {
document.getElementById("nine").style.backgroundColor = "#87CEFA"
} else if (time.isBefore(beforeTime)) {
document.getElementById("nine").style.backgroundColor = "#F08080"
} else {
document.getElementById("nine").style.backgroundColor = "#20B2AA" 
}
};
// Activating color-coding time function on page load.
nine();
